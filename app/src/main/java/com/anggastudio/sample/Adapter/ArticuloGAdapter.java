...
public class ArticuloGAdapter extends RecyclerView.Adapter<ArticuloGAdapter.ViewHolder>{
    ...
    public ArticuloGAdapter(List<Articulo> articuloGList, Map<String, Integer> cantidadesSeleccionadas, Map<String, Double> nuevosPrecios,TextView totalmontoCar, OnItemClickListener listener){
