...
public class ArticuloAdapter extends RecyclerView.Adapter<ArticuloAdapter.ViewHolder>{
    ...
    public ArticuloAdapter(List<Articulo> articuloList, OnItemClickListener listener){
    ...
    public void setOnDeseleccionarArticuloListener(OnDeseleccionarProductoListener listener) {
